...
-- Folding
vim.api.nvim_set_keymap('n', '<leader>co', ':BufferLineCloseOthers<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>of', [[<cmd>lua require('ufo').openAllFolds()<CR>]], { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>cf', [[<cmd>lua require('ufo').closeAllFolds()<CR>]], { noremap = true, silent = true })
