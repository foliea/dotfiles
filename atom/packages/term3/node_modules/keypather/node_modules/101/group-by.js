 ...
 * @function module:101/group-by
 * @param {array|function|string} arr|indexer - array of objects to be grouped
 * @param {string|function} indexer - the common keypath or function which accepts an object and returns an index key
 * @return {obj|function} grouped|indexByPartial An object whose keys are the values of their common key and values are the original values.
